...
The laptop took about ~5 seconds to complete the calculations, while the server took ~9 seconds. The most time is wasted in finding GO calculations. So the discrepancy might actually be mainly due to disk IO (AnnotationDbi uses an SQL file to store the GO DAGs).
