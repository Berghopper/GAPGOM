...
geneset_ensembl <- expdata[expdata$V2 %in% geneset,]$V1
...
entrezidsample_filtered <- expdata[ apply(expdata[expdata$V1 %in% entrezidsample,3:ncol(expdata)],1,mean) > 25,]$V1
fakefilter <- unique(c(entrezidsample_filtered, sample(geneset_ensembl, 15)))
# set gid and run.
#gid <- "AGRN"
...
result <- GAPGOM::expression_prediction(gid, 
                                        ...
                                        "MF",
                                        method = "combine", 
                                        verbose = TRUE, go_amount = 2,
                                        significance = 1, enrichment_cutoff = 250)
result
