...
fantom_file <- fantom_download("./", organism = "mouse", noprompt = T) # saves filename
...
# you can also directly load an ExpressionSet from a file;
...
#ENSG00000228630
rowsample <- sample(1:nrow(ExpressionData),1000)
