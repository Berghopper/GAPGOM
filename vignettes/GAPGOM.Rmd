...
Before installing, the package has quite a few dependencies in both cran and Bioconductor. You can run the following block of code (prerably line-by-line because of prompts) to install these and the package itself.

```{r eval=F}
### NEEDED (depends)

install.packages(c("plyr", "dplyr", "data.table", "igraph"))

if (!requireNamespace("BiocManager"))
    install.packages("BiocManager")
BiocManager::install()

BiocManager::install(c("graph", "RBGL", "GO.db", "org.Hs.eg.db", "org.Mm.eg.db", "GOSim", "GOSemSim", "GEOquery", "AnnotationDbi", "Biobase"))

### ADDITIONAL (suggests)

install.packages(c("testthat", "pryr", "knitr", "rmarkdown", "prettydoc", "ggplot2", "kableExtra", "profvis", "reshape2"))

BiocManager::install(c("org.Ag.eg.db", "org.At.tair.db", "org.Bt.eg.db", "org.Ce.eg.db", "org.Cf.eg.db", "org.Dm.eg.db", "org.Dr.eg.db", "org.EcK12.eg.db", "org.EcSakai.eg.db", "org.Gg.eg.db", "org.Mmu.eg.db", "org.Pf.plasmo.db", "org.Pt.eg.db", "org.Rn.eg.db", "org.Sc.sgd.db", "org.Ss.eg.db", "org.Xl.eg.db"))

### DEVELOPER (run these seperate) R 3.6 required!

install.packages(c("devtools", "roxygen2", "stringr", "stringi", "microbenchmark", "R.utils"))
if (!requireNamespace("BiocManager", quietly=TRUE))
    install.packages("BiocManager")
BiocManager::install(version = "devel")
BiocManager::valid()              # checks for out of date packages

### PACKAGE INSTALL - unavailable for now. Use install.packages + tar.gz instead
...
View(expset)
View(assayData(expset)[["exprs"]]) # where expressionvalues are stored.
View(pData(featureData(expset))) # where other information is stored.
```
...
- [1] Ehsani R, Drablos F: [ACCEPTED, UNPUBLISHED] **Measures of co-expression for improved function prediction of long non-cofing RNAs**, 2018.
