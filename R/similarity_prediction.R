...
prediction_function <- function(gene_id, ontology, expression_data, ensembl_to_go_id_conversion_df, start_expression_col, end_expression_col, enrichment_cutoff = 250, method = "combine") {
    ...
    if (method == "Pearson") {
        ...
        enrichment_result <- UGenePred::enrichment_analysis(ordered_score_df, ontology, ensembl_to_go_id_conversion_df, ensembl_id_pc, enrichment_cutoff)
        ...
        enrichment_pearson <- UGenePred::enrichment_analysis(ordered_score_df_pearson, ontology, ensembl_to_go_id_conversion_df, ensembl_id_pc, enrichment_cutoff)
        enrichment_spearman <- UGenePred::enrichment_analysis(ordered_score_df_spearman, ontology, ensembl_to_go_id_conversion_df, ensembl_id_pc, enrichment_cutoff)
        enrichment_sobolev <- UGenePred::enrichment_analysis(ordered_score_df_sobolev, ontology, ensembl_to_go_id_conversion_df, ensembl_id_pc, enrichment_cutoff)
        enrichment_fisher <- UGenePred::enrichment_analysis(ordered_score_df_fisher, ontology, ensembl_to_go_id_conversion_df, ensembl_id_pc, enrichment_cutoff)
